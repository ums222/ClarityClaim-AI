...
function StatCard({ 
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-2xl border border-neutral-100 shadow-sm hover:shadow-md transition-shadow overflow-hidden"
    >
      <div className="p-5">
          ...
          <div>
            ...
            {trend && (
              <div className="flex items-center mt-2 text-xs">
                ...
                <span className="text-neutral-400 ml-1">{trend.label}</span>
              </div>
            )}
          </div>
...
function AppealRow({ appeal }: { appeal: Appeal }) {
  ...
  return (
    ...
    >
        ...
        {appeal.claim ? (
          <div>
            <Link 
              ...
              className="text-sm text-neutral-900 hover:text-blue-600 transition-colors"
            >
              {appeal.claim.claim_number}
            </Link>
            <p className="text-xs text-neutral-500">{appeal.claim.patient_name}</p>
          </div>
        ) : (
          <span className="text-sm text-neutral-400">No linked claim</span>
        )}
      </td>
      <td className="px-6 py-4 whitespace-nowrap">
      ...
      <td className="px-6 py-4">
        <div className="max-w-xs">
          ...
          {appeal.original_denial_code && (
            <p className="text-xs text-neutral-500">Code: {appeal.original_denial_code}</p>
          )}
        </div>
      </td>
      ...
      <td className="px-6 py-4 whitespace-nowrap">
        {appeal.deadline ? (
          <div className={`flex items-center ${isPastDeadline ? 'text-red-600' : isUrgent ? 'text-amber-600' : 'text-neutral-500'}`}>
            {isPastDeadline ? (
      ...
      <td className="px-6 py-4 whitespace-nowrap text-right">
        <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
          ...
          <div className="relative">
            ...
            {showMenu && (
              <div className="absolute right-0 mt-1 w-48 bg-white rounded-lg shadow-lg border border-neutral-100 py-1 z-10">
                <button
                  onClick={() => {
  ...
  return (
    <AppLayout>
      <div className="max-w-[1600px] mx-auto px-2 py-4 lg:px-6 lg:py-6">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 text-neutral-600 bg-white border border-neutral-200 rounded-xl hover:bg-neutral-50 transition-colors"
            >
        ...
        {/* Search and Filters */}
        <div className="bg-white rounded-2xl border border-neutral-100 shadow-sm mb-6">
          <div className="p-4 flex items-center gap-4">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-neutral-50 border border-neutral-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
              />
            </div>
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2.5 border rounded-xl transition-all ${
                showFilters ? 'bg-blue-50 border-blue-200 text-blue-700' : 'bg-neutral-50 border-neutral-200 text-neutral-600 hover:bg-neutral-100'
              }`}
            >
                ...
                <div className="p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 bg-neutral-50 border border-neutral-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
                  ...
                  {/* Appeal Type Filter */}
                  <div>
                    <label className="block text-sm font-medium text-neutral-700 mb-2">Appeal Type</label>
                    <select
                  ...
                  <tr>
                    <td colSpan={9} className="px-6 py-20">
                      <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="text-neutral-500">Loading appeals...</p>
                      </div>
                    </td>
                  </tr>
                ) : appeals.length === 0 ? (
                  <tr>
                    <td colSpan={9} className="px-6 py-20">
                      <div className="flex flex-col items-center justify-center">
                        ...
                        <h3 className="text-lg font-medium text-neutral-900 mb-1">No appeals found</h3>
            ...
            <div className="px-6 py-4 border-t border-neutral-100 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  disabled={page === 1}
                  className="px-3 py-1.5 text-sm border border-neutral-200 rounded-lg hover:bg-neutral-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
                  Previous
                </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
          <Link 
            ...
            className="bg-white rounded-xl border border-neutral-100 p-5 hover:shadow-md hover:border-blue-200 transition-all group"
          >
            <div className="flex items-center justify-between">
              <div>
          ...
          <Link 
            to="/app/analytics"
            className="bg-white rounded-xl border border-neutral-100 p-5 hover:shadow-md hover:border-purple-200 transition-all group"
          >
            <div className="flex items-center justify-between">
              <div>
              ...
              <ArrowUpRight className="w-5 h-5 text-neutral-400 group-hover:text-purple-600 transition-colors" />
            </div>
          </Link>

          <Link 
            to="/app/claims?status=denied"
            className="bg-white rounded-xl border border-neutral-100 p-5 hover:shadow-md hover:border-amber-200 transition-all group"
          >
            <div className="flex items-center justify-between">
              <div>
