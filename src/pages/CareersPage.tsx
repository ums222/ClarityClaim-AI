          ...
          <div className={`rounded-2xl border ${isDark ? "border-slate-800 bg-slate-900/50" : "border-slate-200 bg-slate-50"} p-8 mb-16`}>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              ...
              <div>
                ...
                <p className={`text-sm ${isDark ? "text-slate-400" : "text-slate-600"}`}>Series B Funding</p>
              </div>
              <div>
                <p className={`text-3xl font-bold ${isDark ? "text-teal-400" : "text-teal-600"}`}>500+</p>
                <p className={`text-sm ${isDark ? "text-slate-400" : "text-slate-600"}`}>Customers</p>
              </div>
              <div>
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {benefits.map((benefit) => (
                <div 
                  key={benefit.title}
                  className={`flex items-start gap-4 p-6 rounded-2xl border ${isDark ? "border-slate-800 bg-slate-900/50" : "border-slate-200 bg-slate-50"}`}
                >
            ...
            <div className="space-y-4">
              {filteredJobs.map((job) => (
                ...
                >
                  ...
                  >
                    <div className="flex-1">
                      <div className="flex flex-wrap items-center gap-3 mb-2">
                        ...
                        <span className={`px-2 py-0.5 rounded text-xs font-medium ${isDark ? "bg-slate-800 text-slate-400" : "bg-slate-200 text-slate-600"}`}>
                          {job.department}
                        </span>
                      </div>
                    ...
                    {expandedJob === job.id ? (
                      <ChevronUp className={`h-5 w-5 ${isDark ? "text-slate-400" : "text-slate-600"}`} />
                    ) : (
                  ...
                  {expandedJob === job.id && (
                    <div className={`px-6 pb-6 pt-2 border-t ${isDark ? "border-slate-800" : "border-slate-200"}`}>
