            ...
            <div className={`prose max-w-none ${isDark ? "prose-invert" : ""}`}>
              ...
              <section className="mb-8">
                ...
                <div className="grid gap-4 not-prose">
                  {cookieTypes.map((type) => (
                    <div 
                      key={type.title}
                      className={`p-5 rounded-xl border ${isDark ? "border-neutral-700 bg-neutral-800/50" : "border-neutral-200 bg-white"}`}
                    >
                      <div className="flex items-start gap-4">
                        <div className={`p-2 rounded-lg ${isDark ? "bg-neutral-700" : "bg-neutral-100"}`}>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {type.examples.map((example) => (
                              <span 
                                key={example}
                                className={`text-xs px-2 py-1 rounded ${isDark ? "bg-neutral-700 text-neutral-300" : "bg-neutral-100 text-neutral-600"}`}
                              >
                                {example}
                              </span>
                            ))}
              ...
              <section className="mb-8">
                ...
                <div className={`overflow-x-auto not-prose`}>
                  <table className={`w-full text-sm ${isDark ? "text-neutral-300" : "text-neutral-700"}`}>
                    <thead>
                      <tr className={`border-b ${isDark ? "border-neutral-700" : "border-neutral-200"}`}>
                        <th className={`text-left py-3 px-4 font-semibold ${isDark ? "text-white" : "text-neutral-900"}`}>Cookie Name</th>
                        <th className={`text-left py-3 px-4 font-semibold ${isDark ? "text-white" : "text-neutral-900"}`}>Purpose</th>
                        <th className={`text-left py-3 px-4 font-semibold ${isDark ? "text-white" : "text-neutral-900"}`}>Duration</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className={`border-b ${isDark ? "border-neutral-800" : "border-neutral-100"}`}>
