        ...
        <div className="mx-auto max-w-6xl px-4 md:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {mediaCoverage.map((coverage) => (
                    ...
                    >
                      <div className={`w-10 h-10 rounded-lg flex-shrink-0 ${isDark ? "bg-slate-800" : "bg-slate-100"} flex items-center justify-center`}>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className={`text-sm font-medium line-clamp-2 ${isDark ? "text-white" : "text-slate-900"}`}>
                          {coverage.title}
                        </p>
                      ...
                      <ExternalLink className={`h-4 w-4 flex-shrink-0 ${isDark ? "text-slate-500" : "text-slate-400"}`} />
                    </a>
                  ))}
                </div>
              </div>
              ...
              {/* Press Kit */}
              <div className={`rounded-xl border p-6 ${isDark ? "border-slate-800 bg-slate-900/50" : "border-slate-200 bg-slate-50"}`}>
