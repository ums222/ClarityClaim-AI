        ...
        <div className="mt-8 grid gap-8 md:grid-cols-[3fr_2fr]">
          ...
          <div>
            <div className="relative hidden md:flex items-center justify-between mb-6">
              ...
              {steps.map((step) => (
                ...
                >
                  ...
                  <span className="text-[10px] font-semibold tracking-[0.2em] text-slate-600 dark:text-slate-500">
                    {step.label}
                  </span>
                </button>
              ))}
                ...
                return (
                  <button
                    ...
                    className={
                      ...
                      (active
                        ? "border-clarity-secondary bg-white dark:bg-slate-900/80"
                        : "border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/40")
                    }
                  >
                    <span className="mt-1 flex h-8 w-8 items-center justify-center rounded-full bg-slate-100 dark:bg-slate-900">
            ...
            <motion.div
              ...
              className="mt-8 hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/80 p-5 md:block"
            >
          ...
          <div className="flex flex-col justify-between gap-6">
            <div className="relative h-40 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/80 p-4">
