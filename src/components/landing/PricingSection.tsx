  ...
  return (
    <SectionContainer id="pricing" className="bg-white dark:bg-slate-950">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        {/* Starter */}
        <Card className="bg-white/80 border border-slate-200 dark:border-transparent dark:bg-slate-900/70">
          <CardHeader>
            <p className="text-xs uppercase tracking-[0.2em] text-slate-500">
              Starter
            </p>
            <CardTitle className="text-slate-900 dark:text-slate-50">Small Practices & Clinics</CardTitle>
        ...
        {/* Professional */}
        <Card className="relative bg-slate-50 border-2 border-clarity-secondary/40 dark:border-transparent dark:bg-slate-900/90 shadow-glow-primary">
          ...
          <CardHeader>
            ...
            <CardTitle className="text-slate-900 dark:text-slate-50">Regional Health Systems</CardTitle>
            <CardDescription className="mt-4 text-2xl font-semibold text-slate-900 dark:text-slate-50">
              {proPrice}
            </CardDescription>
        ...
        <Card className="bg-white/80 border border-slate-200 dark:border-transparent dark:bg-slate-900/70">
          <CardHeader>
            ...
            <CardTitle className="text-slate-900 dark:text-slate-50">Large Health Systems & IDNs</CardTitle>
            <CardDescription className="mt-4 text-2xl font-semibold text-slate-900 dark:text-slate-50">
              Custom
            </CardDescription>
      ...
      <div className="mt-8 rounded-2xl border border-clarity-secondary/40 bg-slate-50 dark:bg-slate-900/80 p-5 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
