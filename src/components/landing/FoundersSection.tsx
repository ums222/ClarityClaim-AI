...
// Memoized founder card
const FounderCard = memo<{ founder: typeof founders[number]; index: number }>(
  ({ founder, index }) => (
    <m.div
        ...
        <CardContent className="flex flex-1 flex-col justify-between">
          ...
          <div className="mt-4 flex items-center justify-between">
            ...
            <a
              ...
              className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-slate-700 bg-slate-900/70 text-slate-300 hover:text-slate-50 hover:border-slate-500 transition-colors"
            >
