    ...
    <SectionContainer id="founders"  className="bg-white dark:bg-slate-950">
      ...
      <div className="mt-8 grid gap-6 md:grid-cols-3">
        {founders.map((f, i) => (
          ...
          >
            <Card className="flex h-full flex-col bg-white dark:bg-slate-900/70 hover:-translate-y-1 hover:shadow-glow-primary transition-all duration-200">
              <CardHeader>
              ...
              <CardContent className="flex flex-1 flex-col justify-between">
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <a
                    ...
                    className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900/70 text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-50 hover:border-slate-400 dark:hover:border-slate-500"
                  >
