        ...
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              <a href="#" aria-label="LinkedIn" className="text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-100 transition-colors">
                <Linkedin className="h-4 w-4" />
              </a>
              <a href="#" aria-label="Twitter/X" className="text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-100 transition-colors">
              ...
              {["Features", "Integrations", "Pricing", "Security", "API Documentation"].map(
                (item) => (
                  <li key={item}>
                    <a
                      href="#"
                      className="text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-100 hover:underline underline-offset-4 transition-colors"
                    >
                      {item}
                    </a>
                  </li>
            ...
            {["Privacy Policy", "Terms of Service", "HIPAA Notice", "Cookie Policy"].map(
              (item) => (
                <Link
                  key={item}
                  to="#"
                  className="text-slate-500 hover:text-slate-900 dark:hover:text-slate-100 hover:underline underline-offset-4 transition-colors"
                >
                  {item}
                </Link>
              )
