        ...
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              <a href="https://www.linkedin.com/company/clarityclaim-ai" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-slate-500 hover:text-slate-700 dark:hover:text-slate-300 transition-colors">
